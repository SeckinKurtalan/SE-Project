  ...
  return (
   <div className='navbar'>
    <div className='container'>
      ...
      <img onClick={handleDashboardClick} src="/main-logo.png" alt="" srcset="" className='main-logo' />
      </div>
      <div className="nav-right-container">
      <div className="main-page-container">
            <a onClick={handleDashboardClick} href="#" className="main-page-link">Main Page</a>
        </div>
